...
void DownloadsWidget::retranslateUi()
{
    autoSearchCheck->setText(tr("Auto"));
    stateComboBox->clear();
    stateComboBox->addItem(tr("All"));
    stateComboBox->addItem(tr("Running"));
    stateComboBox->addItem(tr("Stopped"));
    stateComboBox->addItem(tr("Finished"));
    stateComboBox->addItem(tr("Canceled"));
}
