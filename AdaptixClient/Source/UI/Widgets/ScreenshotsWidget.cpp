...
void ScreenshotsWidget::actionDownload()
{
    ...
    NonBlockingDialogs::getSaveFileName(this, tr("Save File"), baseDir, "All Files (*.*)",
...
void ScreenshotsWidget::retranslateUi()
{
    autoSearchCheck->setText(tr("auto"));
    autoSearchCheck->setToolTip(tr("Auto search on text change. If unchecked, press Enter to search."));
}

void ScreenshotsWidget::changeEvent(QEvent* event)
{
