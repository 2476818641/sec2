...
void TasksWidget::createUI()
{
    ...
    autoSearchCheck = new QCheckBox(searchWidget);
...
void TasksWidget::retranslateUi()
{
    ...
    if (comboAgent->count() > 0)
        comboAgent->setItemText(0, tr("All agents"));
    if (comboType->count() > 0)
        comboType->setItemText(0, tr("All types"));
    if (comboStatus->count() >= 6) {
        comboStatus->setItemText(0, tr("Any status"));
        comboStatus->setItemText(1, tr("Hosted"));
        comboStatus->setItemText(2, tr("Running"));
        comboStatus->setItemText(3, tr("Success"));
        comboStatus->setItemText(4, tr("Error"));
        comboStatus->setItemText(5, tr("Canceled"));
    }
